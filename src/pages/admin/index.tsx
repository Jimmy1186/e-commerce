  ...
  const convertContentToHTML = () => {
    const currentContentAsHTML = convertToHTML({
      ...
      blockToHTML: (block) => {
        ...
        if(block.data["text-align"]!=undefined){
      ...
      {({ errors, values, handleChange, isValid, setFieldValue }) => (
        <main className="mx-auto flex h-full w-full grid-cols-6 flex-col gap-3 bg-stone-100 px-3  pt-24 ">
          ...
          <Form className="flex flex-col gap-5">
              ...
              <Editor
                ...
                toolbar={{
                  ...
                  colorPicker: {
                    ...
                    // className: "text-",
                    // component: undefined,
                    colors: ['#fafaf9','#e7e5e4','#78716c','#44403c','#1c1917'
                    ,'#ef4444','#f97316','#f59e0b','#eab308','#84cc16','#22c55e','#10b981','#14b8a6',
                  '#06b6d4','#0ea5e9','#3b82f6','#6366f1','#8b5cf6','#a855f7','#d946ef','#ec4899','#ec4899','#f43f5e'],
                  },
                  textAlign: {
                    // inDropdown: false,
                    // className: undefined,
            ...
            <div className="">
            <div className="content flex flex-col" dangerouslySetInnerHTML={{ __html:convertedContent }} />;
            </div>
